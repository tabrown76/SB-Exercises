...
describe("GET /companies", function () {
  ...
  test('nameLike query', async function () {
  ...
  test('minEmployees query', async function () {
  ...
  test('maxEmployees query', async function () {
  ...
  test('minEmployees & maxEmployees query', async function () {
  ...
  test('throws 404 error', async function () {
    const resp = await request(app).get(`/companies?nameLike=1&minEmployees=2`);
